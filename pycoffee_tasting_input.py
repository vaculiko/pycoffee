...
layoutBeans = [
    ...
    [sg.Slider(key='Type', range=(0, 100), resolution=5, orientation='h', disable_number_display=True, default_value=100, font=base_font, enable_events=True)],
...
[windowBeans[key].bind('<FocusIn>', '+FOCUS IN+') for key in autodelete] # List comprehension for space reduction
