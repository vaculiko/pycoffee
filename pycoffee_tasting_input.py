...
def main(username, screen_size=(300, 600)):
    ...
    # ---- Buttons ---- #
    buttons = [
        [sg.Button(button_text='Vybrat přípravu', key='Next', bind_return_key=True, focus=True,
                   auto_size_button=None, tooltip='Kliknutím přejdeš na známkování chuti', font=('Any 24'),
    ...
    <def_txs> on the same position as <key> in <keys>.
        # E.g. on the first position of <keys> there is 'Country', on first position of 
    ...
    <key+'+FOCUS IN+'> and it is generated by Focus Event Binding code above).
        # If such Focus event was created (user clicked on thetext input field) and <value> of 
